  ...
  if(getPhaseLevelOfGame(gameId) === 0){
    ...
    if(digit === "5"){
      if(checkOtherUserinRoom(gameId,userPhoneNumber)){
        ...
        global.communicationApi.startHandCricketGame(gameId,params)
      }
    }
  }
  else{
      ...
      if(OtherDigit !== null){
        ...
        if(digit === OtherDigit){
          if(getPhaseLevelOfGame(gameId) === 1){
            ...
            global.communicationApi.playMessageAndContinueTheHandCricketGame(gameId,params)
          }
            ...
            global.communicationApi.playMessageAndFinishTheHandCricketGame(gameId,params)
          }
        }
        else{
        ...
        global.communicationApi.playMessageToUserInHandCricketGame(gameId,userPhoneNumber,message)
      }
    }
    else{
      return;
